...
DB_URL="https://raw.githubusercontent.com/ajijainalganteng-wq/permission/main/regist"
...
# CONFIG
wget -qO /etc/zivpn/config.json https://raw.githubusercontent.com/ajijainalganteng-wq/scripts/main/udp/config.json
